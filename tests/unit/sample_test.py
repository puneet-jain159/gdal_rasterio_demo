from gdal_rasterio_demo.tasks.sample_etl_task import SampleETLTask
from gdal_rasterio_demo.tasks.sample_ml_task import SampleMLTask
...
def test_jobs(spark: SparkSession, tmp_path: Path):
    ...
    test_ml_config = {
        "input": common_config,
        "experiment": "/Shared/gdal_rasterio_demo/sample_experiment"
    }
